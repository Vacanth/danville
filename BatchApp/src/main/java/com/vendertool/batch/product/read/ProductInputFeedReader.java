...
@Component("productInputReader")
public class ProductInputFeedReader implements ItemReader<ProductBean> {
	private List<ProductBean> list;
	private Iterator<ProductBean> productIterator;
	private long userId;
	
	Map<String,JobParameter> jobParams;
	@BeforeStep
...
//				list = CSVMapHelper.getInstance().getProductBeans(null);
	...
	@Override
	public ProductBean read() throws Exception, UnexpectedInputException, ParseException,
