...
public class Settings{
   	...
   	private Number max_pictures_per_item;
	...
	public void setAdult_content(boolean adult_content){
 	...
 	public boolean getBuying_allowed(){
		return this.buying_allowed;
	}
	public void setBuying_allowed(boolean buying_allowed){
		this.buying_allowed = buying_allowed;
	}
 	public List<String> getBuying_modes(){
		return this.buying_modes;
	}
	public void setBuying_modes(List<String> buying_modes){
	...
	public void setImmediate_payment(String immediate_payment){
 	...
 	public List<String> getItem_conditions(){
		return this.item_conditions;
	}
	public void setItem_conditions(List<String> item_conditions){
		this.item_conditions = item_conditions;
	}
 	public boolean getItems_reviews_allowed(){
		return this.items_reviews_allowed;
	}
	public void setItems_reviews_allowed(boolean items_reviews_allowed){
		this.items_reviews_allowed = items_reviews_allowed;
	}
 	public boolean getListing_allowed(){
		return this.listing_allowed;
	}
	public void setListing_allowed(boolean listing_allowed){
		this.listing_allowed = listing_allowed;
	}
 	public Number getMax_pictures_per_item(){
		return this.max_pictures_per_item;
	}
	public void setMax_pictures_per_item(Number max_pictures_per_item){
	...
	public void setPrice(String price){
 	...
 	public boolean getRounded_address(){
		return this.rounded_address;
	}
	...
	public void setShipping_options(List<String> shipping_options){
 	...
 	public String getShipping_profile(){
		return this.shipping_profile;
	}
	public void setShipping_profile(String shipping_profile){
		this.shipping_profile = shipping_profile;
	}
 	public boolean getShow_contact_information(){
		return this.show_contact_information;
	}
